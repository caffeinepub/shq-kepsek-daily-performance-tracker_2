...
import type { DailyMonitoringRow as _DailyMonitoringRow, DailyReport as _DailyReport, ExternalBlob as _ExternalBlob, RankedDailyReport as _RankedDailyReport, School as _School, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getDailyMonitoringRows(arg0: Time): Promise<Array<DailyMonitoringRow>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDailyMonitoringRows(arg0);
    ...
    async getReportsForDate(arg0: Time): Promise<Array<RankedDailyReport>> {
        if (this.processError) {
            try {
                const result = await this.actor.getReportsForDate(arg0);
    ...
    async saveDailyReport(arg0: DailyReport): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveDailyReport(await to_candid_DailyReport_n26(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_DailyMonitoringRow_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DailyMonitoringRow): Promise<DailyMonitoringRow> {
...
async function from_candid_RankedDailyReport_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _RankedDailyReport): Promise<RankedDailyReport> {
...
async function from_candid_opt_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_DailyReport]): Promise<DailyReport | null> {
    return value.length === 0 ? null : await from_candid_DailyReport_n11(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_School]): School | null {
    return value.length === 0 ? null : value[0];
}
...
async function from_candid_record_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        report: record_opt_to_undefined(await from_candid_opt_n21(_uploadFile, _downloadFile, value.report)),
...
async function from_candid_vec_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_DailyMonitoringRow>): Promise<Array<DailyMonitoringRow>> {
    return await Promise.all(value.map(async (x)=>await from_candid_DailyMonitoringRow_n19(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_RankedDailyReport>): Promise<Array<RankedDailyReport>> {
    return await Promise.all(value.map(async (x)=>await from_candid_RankedDailyReport_n23(_uploadFile, _downloadFile, x)));
}
async function to_candid_DailyReport_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: DailyReport): Promise<_DailyReport> {
