...
import { useGetCallerSchool, useGetCallerDailyReport } from '../hooks/useQueries';
...
export default function KepsekDashboardPage() {
  ...
  const { data: selectedReport, isLoading: reportLoading, error: reportError } = useGetCallerDailyReport(selectedDate || new Date());
